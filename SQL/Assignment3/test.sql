...
(
    ...
    `QuestionID` TINYINT UNSIGNED,
     CONSTRAINT fk_eq1 FOREIGN KEY (ExamID) REFERENCES Exam (ExamID) On Delete set null,
	 CONSTRAINT fk_eq2 FOREIGN KEY (QuestionID) REFERENCES Question (QuestionID)On Delete set null
);
